<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y"); ?> &copy; MediBhai. Brought to you by <a href="#">Medibhai.com</a> </div>
</div>
<!--end-Footer-part-->
...
<script src="<?php echo base_url();?>js/matrix.calendar.js"></script> 
